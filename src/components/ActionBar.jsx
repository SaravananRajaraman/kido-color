 ...
 */
export default function ActionBar({ onUndo, onRedo, onClear, onDone, onSave, onDownload, clearLabel = 'Clear' }) {
  return (
    <div className="action-bar" role="toolbar">
      ...
      {onDone     && <button className="action-btn btn-done"     onClick={onDone}     aria-label="Mark done">✅ Done!</button>}
